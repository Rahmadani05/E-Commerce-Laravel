...
class Controller extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->rajaOngkirOrigin = config('services.rajaongkir.origin');
    }
    ...
    protected function getProvinces()
    {
        ...
        if (!$isExistProvinceJson) {
            ...
            Log::info('Provinces response: ' . json_encode($response));
    ...
    protected function getCities($provinceId)
    {
        ...
        if (!$isExistCitiesJson) {
            ...
            Log::info('Cities response for province ' . $provinceId . ': ' . json_encode($response));
